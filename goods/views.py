...
#         return JsonResponse()
from goods.serializers import MainWheelSerializer, MainShowsSerialzier, MainShopsSerializer, MainMustBuySerializer, \
...
class MarketView(viewsets.GenericViewSet,
    ...
    def list(self, request, *args, **kwargs):
        ...
        # split('#')  ['全部分类:0', '酸奶乳酸菌:103537','牛奶豆浆:103538','面包蛋糕:103540']
        # 简单写法
        ...
        # 推导式写法
        foodtypenames_list = [{'child_name': i.split(':')[0], 'child_value': i.split(':')[1]} for i in foodtype.childtypenames.split('#')]
        rule_list = [
